...
<head>
	...
	<title>La Proveedora | Agregar editorial</title>
	<style>
		.content {
			margin-top: 80px;
		}
	...
	<div class="container">
		<div class="content">
			...
			if(isset($_POST['add'])){
				...
				$cek = mysqli_query($bks, "SELECT * FROM publisher WHERE id_publisher='$id_publisher'");
				if(mysqli_num_rows($cek) == 0){
						$insert = mysqli_query($bks, "INSERT INTO publisher(id_publisher, name_publisher)
															VALUES('$id_publisher','$name_publisher')") or die(mysqli_error());
						if($insert){
			...
			<form class="form-horizontal" action="" method="post">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label">Nombreeditorial</label>
					<div class="col-sm-4">
