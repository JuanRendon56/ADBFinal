...
<head>
	...
	<title>La Proveedora | Detalles del género</title>
...
<body>
	...
	<div class="container">
		<div class="content">
			...
			<a href="listG.php" class="btn btn-sm btn-info">Regresar</a>
			<a href="editG.php?nik=<?php echo $row['nik']; ?>" class="btn btn-sm btn-success">Editar datos</a>
			<a href="profileG.php?aksi=delete&nik=<?php echo $row['nik']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Esta seguro de borrar los datos <?php echo $row['name_genre']; ?>')">Eliminar</a>
		</div>
	</div>
</body>
</html>
